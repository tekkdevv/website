...
export function MarketingHero() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-[#070612]">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_75%_40%,rgba(255,255,255,0.14),transparent_22%),linear-gradient(90deg,rgba(7,6,18,0.96)_0%,rgba(7,6,18,0.82)_38%,rgba(7,6,18,0.4)_68%,rgba(7,6,18,0.85)_100%)]" />
